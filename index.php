...
<main>
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary">
    <div class="col-md-6 p-lg-5 mx-auto my-5">
      <h1 class="display-3 fw-bold">MyAnonymousChat</h1>
      <h3 class="fw-normal text-muted mb-3">Chat with Your Friends without worrying about the chat logs. Now you can freely chat with your friends using our free platform </h3>
      <div class="d-flex gap-3 justify-content-center lead fw-normal">

      <form action="claim.php" method="post">myanonymouschat.com/<input type="text" name="room">



        <button class="icon-link mt-3 bg-blue" href="#">
          Claim Room
